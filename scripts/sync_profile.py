...
def build_readme(user: dict, repositories: list[dict], events: list[dict], contribution_snake_version: str) -> str:
    ...
    lines = [
        ...
        *native_footprint(repositories),
        "",
        "<picture>",
        f"  <source media=\"(prefers-color-scheme: dark)\" srcset=\"https://raw.githubusercontent.com/{OWNER}/{OWNER}/output/github-snake-dark.svg\">",
        f"  <source media=\"(prefers-color-scheme: light)\" srcset=\"https://raw.githubusercontent.com/{OWNER}/{OWNER}/output/github-snake.svg\">",
        f"  <img src=\"https://raw.githubusercontent.com/{OWNER}/{OWNER}/output/github-snake.svg\" alt=\"Animated contribution snake tracker across the complete public GitHub contribution calendar.\" width=\"100%\">",
        "</picture>",
        "",
